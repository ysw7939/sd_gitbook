...
수확한 작물을 64개 단위로 묶어 **압축 묶음**으로 만들 수 있습니다. 인벤토리 공간을 아끼고, [🧑‍🍳 요리](cooking.md) 레시피에 필요한 `[압축]` 재료로도 사용됩니다.

<figure><img src="../.gitbook/assets/box_wheat.png" alt=""><figcaption></figcaption></figure>
...
* **[🧑‍🍳 요리](cooking.md)** — 중·고급 요리 레시피에서 `[압축]감자`, `[압축]밀`, `[압축]호박`, `[압축]당근`, `[압축]수박`, `[압축]사탕수수` 등이 재료로 사용됩니다.
...
| 명령어                                          | 설명                          | 권한           |
| -------------------------------------------- | --------------------------- | ------------ |
| `/에센셜 압축권한 지급 <플레이어>`                        | 플레이어에게 영구 압축 권한 지급          | 관리자          |
| `/에센셜 압축권한 회수 <플레이어>`                        | 영구 압축 권한 회수                 | 관리자          |
| `/에센셜 압축권한 상태 <플레이어>`                        | 플레이어의 현재 압축 권한/남은 횟수 확인     | 관리자          |
